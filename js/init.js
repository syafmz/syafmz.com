...
function tokyo_tm_popup(){
	...
	jQuery('.portfolio_zoom').each(function() { // the containers for all your galleries
		jQuery(this).magnificPopup({
			delegate: 'a.p_zoom', // the selector for gallery item
			type: 'image',
			gallery: {
			  enabled:true
			},
  ...
  jQuery('.gallery_zoom').each(function() { // the containers for all your galleries
		jQuery(this).magnificPopup({
			delegate: 'a.g_zoom', // the selector for gallery item
			type: 'image',
			gallery: {
			  enabled:true
			},
